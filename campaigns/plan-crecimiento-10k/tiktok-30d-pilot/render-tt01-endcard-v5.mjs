...
const assetDir = path.join(outputDir, "tt01-endcard-v5");

const outputVideo = path.join(outputDir, "TT01-final-enba-v5-endcard-logo-only.mp4");
const mainClip = path.join(assetDir, "tt01-main-cut-27s.mp4");
const endCardPng = path.join(assetDir, "tt01-endcard-logo-only.png");
const endCardVideo = path.join(assetDir, "tt01-endcard-logo-only.mp4");
