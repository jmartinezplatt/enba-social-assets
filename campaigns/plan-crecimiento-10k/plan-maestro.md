...
**Ultima actualizacion:** 03 de mayo de 2026
...
- 1.924 assets curados en asset-bank (1.281 fotos + 643 videos, post-curación 03/05). Local-first: subcarpetas ignoradas por git.
...
*Actualizado: 02 de mayo de 2026 (sesión día 14/27) — Gate 3 VERDE: 1,044 follows (966 FB + 78 IG) vs 800 target. Review Bruno: reel-eng-v2 WINNER ENG CPV $0.87, corporativo WINNER IG CPV $25 (freq 1.68), FB_static01 prometedor CPF ~$62. Auditoría targeting completa: Montevideo removido de ig_cold+fb_cold (24→23 intereses), D2 (IGEngagers_90d) agregada a ig_retarget+fb_retarget, targeting_relaxation OFF en retargets, FB Stories excluido de fb_cold (CPF $408), AS_ENG_REEL intereses ampliados 4→23, 23 intereses validados (0 deprecados). Ad set ENBA_Follow_IG_Test_NAU creado (120239871906750139): 4 intereses náuticos puros (Vendée Globe, Boat show, Yachting magazine, American Sailing Association) + LAL1 + advantage_audience ON. static01+static02 movidos de ig_cold a ig_test. ig_cold reducido $5K→$3.5K. Gasto IG neutro $6.5K. Meta Verified Business Plus evaluado: sin impacto en ads/delivery, beneficios orgánicos (badge, perfil destacado, 2 links reels/mes). Aplicación automática Meta rechazada. Spend total: $267,372, restante $232,628. Pendientes: review ig_test_NAU 04/05, evaluar microreel_IG_Cold y FB_static02, escalar reel-eng-v2 05/05, REEL-01 producción.*
*Actualizado: 03 de mayo de 2026 (sesión curación asset-bank) — Curación completa carpeta Veleros de Google Photos: 2.579 archivos procesados, 156 ingresados (139 fotos + 17 videos). Reclasificación masiva: 1.670 acciones manuales de Jose (997 moves foto + 114 deletes foto + 488 moves video + 71 deletes video). Raíz limpia (0 archivos). Asset-bank final: 1.924 archivos en 7 subcarpetas (destinos, escuela-aprendizaje, servicios, travesias-navegacion, buenos-aires-paisaje, veleros-broker, grupos-experiencia). Decisión local-first documentada en asset-bank/README.md — subcarpetas ignoradas por git (1.3 GB fotos + 3 GB videos). Grid curado IG: preview grid-curado-preview.html generado, sin ejecutar — pendiente brief producción Dani. Pendientes de pauta del día 14 trasladados a esta sesión: review ig_test_NAU (04/05), evaluar microreel_IG_Cold (pausar si CPV>$40), evaluar FB_static02 (pausar si CPF>$150), escalar reel-eng-v2 si CPV<$1 (05/05), REEL-01 producción, actualizar presupuesto-v4.*

*Actualizado: 06 de mayo de 2026 (sesión cierre) — Fix email stories [undefined]→[Fase 3]: campo `category` ausente en fase3-manifest.json (era específico de Fase 2). Patch quirúrgico vía API en workflows Mañana (q1nZVNrtEsxKEFni) + Noche (c8MHANGzW56GORAi). Script: scripts/patch-stories-category-fix.py. Verificación POST-PUT OK. Nota de Fase 4 guardada en memoria (project_stories_phases.md). — Bruno día 18/27 analizado: veredictos automáticos todos confirmados. Ads REEMPLAZAR: microreel_IG_Cold ($44/visita), microreel_IG_Retarget ($63/visita), nosotros_FB_Cold ($100/like) — sin reemplazo disponible, no se pausan. Ads LEARNING: FB_static01_Retarget ($690/like) y FB_static02_Retarget ($566/like) — revisar 07/05 con 48h de data. WINNER sostenido: corporativo_IG_Cold ($23/visita). Acciones pendientes aprobación Jose: (1) escalar corporativo_IG_Cold $4.200→$5.000/día, (2) revisar retarget FB 07/05, (3) brief urgente a Dani: 2 creativos IG estáticos 4×5 + 1 FB estático para reemplazar los 3 REEMPLAZAR. Seguidores: FB 1.091, IG 96. Total nuevos: 1.153. Pace: 64/día vs 531 necesarios.*
