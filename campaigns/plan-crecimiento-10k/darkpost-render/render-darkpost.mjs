    ...
    <style>
      ...
      body {
        background:
          ...
          linear-gradient(140deg, rgba(10, 21, 32, 0.82) 0%, rgba(18, 44, 68, 0.76) 100%);
      }
      ...
      .veil {
        background:
          linear-gradient(180deg, rgba(10, 21, 32, 0.10) 0%, rgba(10, 21, 32, 0.45) 58%, rgba(10, 21, 32, 0.65) 100%),
  ...
  <body>
    ...
    <div class="content">
      ...
      <div class="bottom" style="justify-content:center;">
        <span class="url">${piece.url ?? 'www.espacionautico.com.ar'}</span>
      </div>
    </div>
  </body>
</html>`;
